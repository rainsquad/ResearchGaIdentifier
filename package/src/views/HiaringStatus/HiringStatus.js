...
const HiaringStatus = () => {
    ...
    const fetchJobRoles = async () => {
        try {
            const response = await axios.get('http://localhost:5070/api/getJobs');
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:5070/api/update_job/${localStorage.getItem("updating_item")}`, formValues);
    ...
    const deleteCandidate = async (record) => {
        console.log(record)
        try {
            const response = await axios.delete(`http://localhost:5070/api/parsed_cv_data/${record.id}`);
    ...
    const fetchAllParsedCVs = async () => {
        try {
            const response = await axios.get('http://localhost:5070/api/getAllParsedCvs');
    ...
    const fetchAllStatuses = async () => {
        try {
            const response = await axios.get('http://localhost:5070/api/getAllStatuses');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:5070/api/change_status_feedback/${id}`, formValues);
            if (response.status === 200) {
                Swal.fire({
                    position: "top-end",
                    icon: "success",
